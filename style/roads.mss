...
@motorway-shield: #620728; // Lch(20,40,10), error 0.5
@trunk-shield: #5d1b0b; // Lch(21,40,42), error 0.5
@primary-shield: #4c2e00; // Lch(22,40,74), error 2.9
@secondary-shield: #323b00; // Lch(23,40,106), error 3.4
@tertiary-shield: #3b3b3b; // Lch(25,0,0), error 0.1
